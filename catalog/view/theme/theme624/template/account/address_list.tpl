      ...
      <table class="table table-bordered table-hover">
        ...
        <tr>
          ...
          <td class="text-center vcenter" style="width: 0">
              <a href="<?php echo $result['update']; ?>" class="cart-icon-btn material-design-create3" data-toggle="tooltip" title="<?php echo $button_edit; ?>"></a> &nbsp;
              <a href="<?php echo $result['delete']; ?>" class="cart-icon-btn fa fa-trash-o" data-toggle="tooltip" title="<?php echo $button_delete; ?>"></a></td>
        </tr>
        <?php } ?>
      </table>
      <?php } else { ?>
