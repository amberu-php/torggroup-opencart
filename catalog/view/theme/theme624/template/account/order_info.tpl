        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right text-price"><?php echo $product['price']; ?></td>
              <td class="text-right text-price"><?php echo $product['total']; ?></td>
              <td class="text-right" style="white-space: nowrap;"><?php if ($product['reorder']) { ?>
                <a href="<?php echo $product['reorder']; ?>" data-toggle="tooltip" title="<?php echo $button_reorder; ?>" class="cart-icon-btn"><i class="fa fa-shopping-cart"></i></a>
                <?php } ?>
                <a href="<?php echo $product['return']; ?>" data-toggle="tooltip" title="<?php echo $button_return; ?>" class="cart-icon-btn"><i class="material-design-back57"></i></a></td>
            </tr>
            <?php } ?>
          ...
          <tfoot>
            ...
            <tr>
              ...
              <td class="text-right text-price"><?php echo $total['text']; ?></td>
              <?php if ($products) { ?>
              <td></td>
              <?php } ?>
            </tr>
