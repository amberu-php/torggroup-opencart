...
<div class="container">
    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            <h1><i class="fa fa-shopping-cart"></i> <?php echo $heading_title; ?>
                <?php if ($weight) { ?>
                    &nbsp;(<?php echo $weight; ?>)
                <?php } ?>
            </h1>
            ...
            <div class="cart-wrapper">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 0">
                                        <button type="button" data-toggle="tooltip"
                                                title="<?php echo $button_remove; ?>" class="cart-icon-btn"
                ...
                <div class="buttons">
                    ...
                    <div class="pull-right">
                        <a href="<?php echo $checkout; ?>" class="btn btn-primary checkout"><?php echo $button_checkout; ?></a>
                    </div>
                </div>
            </div>
