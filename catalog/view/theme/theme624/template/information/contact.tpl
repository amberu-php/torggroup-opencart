            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <?php if ($image) { ?>
                            <div class="col-sm-4">
                                <div class="logo-block"><img src="<?php echo $image; ?>" alt="<?php echo $store; ?>"
                        ...
                        <div class="col-sm-4">
								<i class="icon material-design-phone370"></i>
                        ...
                        <?php } ?>
                        <div class="col-sm-4">
                            <i class="icon material-design-home149"></i>
