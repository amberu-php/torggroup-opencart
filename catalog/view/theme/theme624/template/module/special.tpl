<div class="box specials">
	...
	<div class="box-content">
			...
			<?php $t=1000; foreach ($products as $product) { $t++ ?>
			<div>
				<div class="product-thumb transition  <?php if ($product['options']) echo 'options' ?>">
                                    ...
                                    <?php foreach ($product['options'] as $option) { ?>
                                        <?php if ($option['type'] == 'select') { ?>
                                            <div
                                                ...
                                                <label class="control-label col-sm-12"
                                                       for="input-option<?php echo $option['product_option_id'] .  $module . $t; ?>"><?php echo $option['name']; ?></label>

                                                <div class="col-sm-12">
                                                    <select
                                                        name="option[<?php echo $option['product_option_id']; ?>]"
                                                        id="input-option<?php echo $option['product_option_id'] .  $module . $t; ?>"
                                                        class="form-control">
                                                ...
                                                <div class="col-sm-12">
                                                    <div
                                                        ...
                                                        <?php foreach ($option['product_option_value'] as $option_value) { ?>
                                                            <div class="radio">
                                                                <label
                                                                    for="option[<?php echo $option['product_option_id'] . $option_value['product_option_value_id'] .  $module . $t; ?>]">
                                                                    <input type="radio" hidden
                                                                           name="option[<?php echo $option['product_option_id']; ?>]"
                                                                           id="option[<?php echo $option['product_option_id'] . $option_value['product_option_value_id'] .  $module . $t; ?>]"
                                        ...
                                        <?php if ($option['type'] == 'file') { ?>
                                            <div
                                                ...
                                                <div class="col-sm-12">
                                                    <button type="button"
                                                            id="button-upload<?php echo $option['product_option_id'] .  $module . $t; ?>"
                    ...
                    <div class="quick_info">
                        <div id="quickview_specials_<?php echo $t . $module ?>" class="quickview-style">
                            <div>
					...
					<div class="image">                        
						...
						<a class="quickview quickview-special" data-rel="details" href="#quickview_specials_<?php echo $t . $module?>"><?php echo $text_quick; ?></a>
