    ...
    <div class="container">
        ...
        <div class="row"><?php echo $column_left; ?>
            ...
            <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
                <h1 class="no-line"><i class="material-design-shuffle24"></i><?php echo $heading_title; ?></h1>
                <?php if ($products) { ?>
                    <div class="table-responsive">
                        <table class="table table-bordered">
                                    ...
                                    <td class="text-center">
                                        <div class="product-thumb">
                                            <a href="<?php echo $product['remove']; ?>" data-toggle="tooltip"
                                               ...
                                               class="cart-icon-btn fa fa-trash-o"></a>
                                            ...
                                            <?php if ($review_status) { ?>
                                                <div class="rating">
                                                    <?php for ($i = 1; $i <= 5; $i++) { ?>
                                                        ...
                                                        <?php } else { ?>
                                                            <span class="fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                        <?php } ?>
                                                    <?php } ?>
                            ...
                            <tr>
                                ...
                                <?php foreach ($products as $product) { ?>
                                    <td class="text-center">
                                        <button type="button" class="product-btn-add" onclick="cart.add('<?php echo $product['product_id']; ?>');"><?php echo $button_cart; ?></button>
                                    </td>
                                <?php } ?>
                            </tr>
                        </table>
