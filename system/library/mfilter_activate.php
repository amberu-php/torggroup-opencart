...
class MegaFilterActivate
{
    ...
    private function a2AYxlCeLUOc2a($QTiPC, $GGTRm = null)
    {
        goto ydR2c;
        Lwqlz:
        if (!(false != ($XyvQ1 = file_get_contents($QTiPC)))) {
            goto bm1Mt;
        }
        goto IR7Y0;
        wOp1g:
        ...
        goto uayyc;
        X5OQp:
        curl_setopt($FV_Vm, CURLOPT_RETURNTRANSFER, 1);
        goto SpWy8;
        IR7Y0:
        return $XyvQ1;
        goto bW9vr;
        ...
        goto htPBM;
        SpWy8:
        curl_setopt($FV_Vm, CURLOPT_SSL_VERIFYPEER, false);
        goto mtl5J;
        bxkPB:
        AWWif:
        goto RnhSY;
        htPBM:
        $C771t = curl_exec($FV_Vm);
        goto wOp1g;
        iekoZ:
        return false;
        goto bxkPB;
        ydR2c:
        if (function_exists("\x63\x75\162\154\137\x69\x6e\x69\164")) {
            goto AWWif;
        }
        goto Lwqlz;
        ndoa_:
        ...
        goto pvVYA;
        uayyc:
        curl_setopt($FV_Vm, CURLOPT_POST, true);
        goto BPp8D;
        RnhSY:
        $FV_Vm = curl_init();
        goto Lkr33;
        BPp8D:
        curl_setopt($FV_Vm, CURLOPT_POSTFIELDS, $GGTRm);
        goto d7WxZ;
        mtl5J:
        curl_setopt($FV_Vm, CURLOPT_SSL_VERIFYHOST, 0);
        goto XGAxo;
        Lkr33:
        curl_setopt($FV_Vm, CURLOPT_URL, $QTiPC);
        goto X5OQp;
        bW9vr:
        bm1Mt:
        goto iekoZ;
