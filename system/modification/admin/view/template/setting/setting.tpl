      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <ul class="nav nav-tabs">
			...
			<li><a href="#tab-footer-social-icons" data-toggle="tab">Footer Social Icons</a></li>
          ...
          <div class="tab-content">
			...
			<div class="tab-pane" id="tab-footer-social-icons">
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="facebook-id">Facebook URL</label>
                <div class="col-sm-10">
                  <input class="form-control" id="facebook-id" type="text" name="config_facebookid" placeholder="Your Facebook Page URL" value="<?php echo $config_facebookid; ?>" />
                </div>
              </div>
			  
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="twitter-id">Twitter URL</label>
                <div class="col-sm-10">
                  <input class="form-control" id="twitter-id" type="text" name="config_twitterid" placeholder="Your Twitter Page URL" value="<?php echo $config_twitterid; ?>" />
                </div>
              </div>
			  
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="vk-id">Vkontakte URL</label>
                <div class="col-sm-10">
                  <input class="form-control" id="vk-id" type="text" name="config_vkid" placeholder="Your Vkontakte Page URL" value="<?php echo $config_vkid; ?>" />
                </div>
              </div>
			  
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="instagram-id">Instagram URL</label>
                <div class="col-sm-10">
                  <input class="form-control" id="instagram-id" type="text" name="config_instagramid" placeholder="Your Instagram Page URL" value="<?php echo $config_instagramid; ?>" />
                </div>
              </div>
			  
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="linked-id">Linkedin URL</label>
                <div class="col-sm-10">
                  <input class="form-control" id="linked-id" type="text" name="config_linkedid" placeholder="Your Linkedin Page URL" value="<?php echo $config_linkedid; ?>" />
                </div>
              </div>
			  
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="youtube-id">Youtube URL</label>
                <div class="col-sm-10">
                  <input class="form-control" id="youtube-id" type="text" name="config_youtubeid" placeholder="Your Youtube Page URL" value="<?php echo $config_youtubeid; ?>" />
                </div>
              </div>
			  
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="google-id">Google URL</label>
                <div class="col-sm-10">
                  <input class="form-control" id="google-id" type="text" name="config_googleid" placeholder="Your Google Page URL" value="<?php echo $config_googleid; ?>" />
                </div>
              </div>
			  
			  <section class="text-center"> by <a target="_blank" href="http://www.avightech.info">Saravanan C Updated by Amberu</a></section>
			  </div>
