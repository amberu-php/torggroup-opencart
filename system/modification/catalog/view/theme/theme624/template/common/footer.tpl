  ...
  <?php if ($footer_top) { ?>
	...
	<div class="copyright">
		<div class="container">
			...
			<!--Footer Social Icons-->
			<span class="footer-social-icons pull-right">
				<?php if ($config_facebookid) { ?>
				<a class="facebook" href="<?php echo $config_facebookid; ?>" target="_blank"><i class="fa fa-facebook"></i></a>
				<?php } ?>
				<?php if($config_twitterid != '') { ?>
				<a class="twitter" href="<?php echo $config_twitterid; ?>" target="_blank"><i class="fa fa-twitter"></i></a>
				<?php } ?>
				<?php if($config_vkid != '') { ?>
				<a class="vk" href="<?php echo $config_vkid; ?>" target="_blank"><i class="fa fa-vk"></i></a>
				<?php } ?>
				<?php if($config_instagramid != '') { ?>
				<a class="instagram" href="<?php echo $config_instagramid; ?>" target="_blank"><i class="fa fa-instagram"></i></a>
				<?php } ?>
				<?php if($config_linkedid != '') { ?>
				<a class="linkedin" href="<?php echo $config_linkedid; ?>" target="_blank"><i class="fa fa-linkedin"></i></a>
				<?php } ?>
				<?php if($config_youtubeid != '') { ?>
				<a class="youtube" href="<?php echo $config_youtubeid; ?>" target="_blank"><i class="fa fa-youtube-square"></i></a>
				<?php } ?>
				<?php if($config_googleid != '') { ?>
				<a class="google" href="<?php echo $config_googleid; ?>" target="_blank"><i class="fa fa-google-plus"></i></a>
				<?php } ?>			
			</span>
			<!--End-->
